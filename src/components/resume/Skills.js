...
const skillsData = [
  {
    ...
    skills: [
      ...
      {
        name: "Flutter",
        icon: "https://cdn-images-1.medium.com/max/1200/1*5-aoK8IBmXve5whBQM90GA.png",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      {
        name: "Git",
        icon: "https://camo.githubusercontent.com/fbfcb9e3dc648adc93bef37c718db16c52f617ad055a26de6dc3c21865c3321d/68747470733a2f2f7777772e766563746f726c6f676f2e7a6f6e652f6c6f676f732f6769742d73636d2f6769742d73636d2d69636f6e2e737667",
      },
      {
        name: "GitHub",
    ...
    <div className="w-full py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 justify-center">
        {skillsData.map((category, index) => (
          <div
            key={index}
            className={`bg-gray-800 hover:bg-gray-700 p-8 rounded-lg shadow-md hover:shadow-lg transition duration-300 ${
              index % 2 === 0 ? "justify-self-center" : "justify-self-center"
            }`}
            style={{ width: "90%" }}
          >
            ...
            <ul className="flex flex-wrap justify-center gap-4">
              {category.skills.map((skill, idx) => (
                <li
                  key={idx}
                  className="flex items-center text-lg font-medium text-center text-gray-400 border border-gray-500 p-2 rounded-md"
                >
                  <img
                    src={skill.icon}
                    alt={skill.name}
